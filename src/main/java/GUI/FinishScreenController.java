...
public class FinishScreenController {
    ...
    public void initialize() {
        switch (new Random().nextInt(2)) {
            case 0:
                introLabel.setText("BẠN ĐÃ ĂN ĐƯỢC");
                ageLabel.setText(MainSystem.getNguoiChoi().getTuoi() + " NỒI BÁNH CHƯNG");
                break;
            default:
                introLabel.setText("BẠN ĐÃ SỐNG ĐƯỢC");
                ageLabel.setText(MainSystem.getNguoiChoi().getTuoi() + " TUỔI");
                break;
        }
    }
